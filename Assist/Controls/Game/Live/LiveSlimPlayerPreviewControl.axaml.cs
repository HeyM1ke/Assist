...
public partial class LiveSlimPlayerPreviewControl : UserControl
{
    public readonly LivePlayerPreviewViewModel _viewModel;
    public string? PlayerId = null;

    public LiveSlimPlayerPreviewControl()
    {
        DataContext = _viewModel = new LivePlayerPreviewViewModel();
        InitializeComponent();
    }
    
    public LiveSlimPlayerPreviewControl(PregameMatch.Player player, IBrush color = null)
    {
        DataContext = _viewModel = new LivePlayerPreviewViewModel();
    ...
    public LiveSlimPlayerPreviewControl(CoregameMatch.Player player, IBrush color = null)
    {
        DataContext = _viewModel = new LivePlayerPreviewViewModel();
    ...
    private async void LiveSlimPlayerPreviewControl_Init(object? sender, EventArgs e)
    {
