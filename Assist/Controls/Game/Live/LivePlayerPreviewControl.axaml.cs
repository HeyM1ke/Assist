...
public partial class LivePlayerPreviewControl : UserControl
{
    public readonly LivePlayerPreviewViewModel _viewModel;
    public string? PlayerId = null;
    public LivePlayerPreviewControl()
    {
        DataContext = _viewModel = new LivePlayerPreviewViewModel();
        InitializeComponent();
    }
    
    public LivePlayerPreviewControl(PregameMatch.Player player, IBrush color = null)
    {
        DataContext = _viewModel = new LivePlayerPreviewViewModel();
    ...
    public LivePlayerPreviewControl(CoregameMatch.Player player, IBrush color = null)
    {
        DataContext = _viewModel = new LivePlayerPreviewViewModel();
